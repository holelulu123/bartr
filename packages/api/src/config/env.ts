...
export const env = {
  ...
  googleClientId: requireInProd('GOOGLE_CLIENT_ID', process.env.GOOGLE_CLIENT_ID, ''),
  googleClientSecret: requireInProd('GOOGLE_CLIENT_SECRET', process.env.GOOGLE_CLIENT_SECRET, ''),
